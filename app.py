...
#variant HB4 comes from https://doi.org/10.1016/j.energy.2014.03.114
def variant_4(baseplant):
    ...
    #out of evaporator to the splitter (between preheater and dh hex)
    ...
    #from the preheater and the dh hex
    c27 = Connection(
...
#variant HB3 comes from https://doi.org/10.1016/j.energy.2014.03.114
def variant_3(nw):
...
optimize = MultivariateOptimizationProblem(plant, variables, constraints, objective)#instantiate the class
